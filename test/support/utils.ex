defmodule Test.Utils do
  ...
  def deploy(contract_file_name) do
    ...
    transaction_count = Ethereumex.WebSocketClient.eth_get_transaction_count("0x" <> Base.encode16(address))
      |> elem(1)
      |> parse_hex()
    ...
    {:ok, transaction_hash} = Ethereumex.WebSocketClient.eth_send_raw_transaction("0x" <> transaction_data)
